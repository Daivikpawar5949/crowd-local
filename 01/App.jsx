...
export default function CrowdLocal() {
  ...
  if (currentPage === 'auth') {
    return (
      <div className="min-h-screen w-full bg-gradient-to-br from-[#0D0D10] via-[#1a1a2e] to-[#0D0D10] overflow-hidden flex items-center justify-center">
        {/* Animated gradient background effect */}
        <div className="fixed inset-0 pointer-events-none">
          <div className="absolute top-20 right-10 w-96 h-96 bg-[#7F00FF] rounded-full mix-blend-screen filter blur-3xl opacity-10 animate-pulse"></div>
          <div className="absolute bottom-20 left-10 w-96 h-96 bg-[#00FF7F] rounded-full mix-blend-screen filter blur-3xl opacity-10 animate-pulse"></div>
        </div>
        ...
        <div className="relative z-10 text-center px-6">
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-[#7F00FF] via-white to-[#00FF7F] bg-clip-text text-transparent mb-4">
              CrowdLocal
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 font-light">
              Fund WIP. Fuel Innovation. Build Together.
            </p>
          </div>

          {/* Glass-morphism Card */}
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-12 max-w-md mx-auto shadow-2xl">
            <p className="text-gray-300 mb-8 text-lg leading-relaxed">
              Welcome to the next generation of crowdfunding. Where early-stage projects meet Gen Z energy.
            </p>

            <button
              onClick={handleNavigateToExplore}
              className="w-full py-4 px-8 bg-gradient-to-r from-[#7F00FF] to-[#9933FF] hover:from-[#9933FF] hover:to-[#BB66FF] text-white font-bold text-lg rounded-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg shadow-[#7F00FF]/50"
            >
              Start Building
            </button>
          </div>
